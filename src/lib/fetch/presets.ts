	...
	(gamePk) => ({
		...
		params: {
			fields: [
				...
				'plays,allPlays,result,description,event,eventType,rbi,about,inning,isTopInning,atBatIndex,isScoringPlay,runnerIndex,count,balls,strikes,outs,awayScore,homeScore,matchup,batter,id,fullName,boxscoreName,playEvents,reviewDetails,inProgress,challengeTeamId,reviewType,hitData,launchSpeed,launchAngle,totalDistance,trajectory,coordinates,coordX,coordY',
			],
		},
	}),
)
