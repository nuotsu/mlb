export { default as AppleTVIcon } from './apple-tv.svelte'
...
export { default as SplitIcon } from './split.svelte'
export { default as SplitFilledIcon } from './split-filled.svelte'
export { default as WBCIcon } from './wbc.svelte'
